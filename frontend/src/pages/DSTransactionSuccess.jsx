  ...
  return (
    <div style={{ height: '100vh', width: '100vw', backgroundColor: '#050505', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', position: 'relative', overflow: 'hidden', fontFamily: '"Inter", sans-serif', boxSizing: 'border-box' }}>
      ...
      >
        ...
        >
          <h1 style={{ margin: '0 0 8px 0', fontSize: '28px', fontFamily: '"Cormorant Garamond", serif', color: '#F3E5AB', fontWeight: 600 }}>Transaction Verified</h1>
          <p style={{ margin: 0, color: '#999', fontSize: '13px', lineHeight: '1.6' }}>
            You are now the verifiable owner of <br/>
            <span style={{ color: '#fff', fontWeight: 500 }}>"{artObject?.artworkTitle}"</span>
          </p>
        </motion.div>
...
export default DSTransactionSuccess;