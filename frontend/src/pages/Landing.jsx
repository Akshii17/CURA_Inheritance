  ...
  const FEATURES_DATA = [
    {
      ...
      desc: "Ownership history is permanently recorded on the blockchain. Verifiable, tamper-proof, and forever yours.",
      icon: Shield,
    },
    {
      id: 2,
      title: "Instant Liquidity",
      desc: "No waiting periods. Smart contracts handle settlements instantly, transferring assets and funds in seconds.",
      icon: Zap,
    },
    {
      id: 3,
      title: "Global Access",
      desc: "A borderless marketplace connecting artists and collectors from every corner of the world.",
      icon: Globe,
    },
    {
      id: 4,
      title: "Non-Custodial",
      desc: "You maintain 100% control. We never hold your private keys or your assets.",
      icon: Lock,
    },
  ];
  ...
  const HOW_IT_WORKS = [
    {
      ...
      desc: "Link your MetaMask or Phantom wallet to authenticate securely.",
      icon: Wallet,
    },
    {
      id: 2,
      title: "Discover Assets",
      desc: "Browse our curated collection of verified digital masterpieces.",
      icon: Search,
    },
    {
      id: 3,
      title: "Place Your Bid",
      desc: "Participate in real-time auctions or buy instantly via smart contracts.",
      icon: Gavel,
    },
    {
      id: 4,
      title: "Claim Ownership",
      desc: "Assets are transferred to your wallet immediately upon payment.",
      icon: Award,
    },
  ];
    ...
    >
      ...
      >
        ...
        <div
          style={{
            ...
            inset: 0,
            background:
              "radial-gradient(circle, rgba(5,5,5,0.5) 0%, rgba(5,5,5,1) 100%)",
            pointerEvents: "none",
          }}
        />
          ...
          >
            ...
            <p
              style={{
                ...
                fontWeight: 500,
                textShadow:
                  "0 0 20px rgba(255,255,255,0.5), 0 4px 12px rgba(0,0,0,0.8)",
              }}
            >
      ...
      {showModal && (
        <div
          ...
          onClick={(e) => {
            if (e.target === e.currentTarget && !needsRegistration) {
              setShowModal(false);
            }
          }}
        >
                ...
                {index < HOW_IT_WORKS.length - 1 && (
                  <div
                    style={{
                      ...
                      height: "1px",
                      background:
                        "linear-gradient(90deg, rgba(124, 58, 237, 0.5) 0%, rgba(124, 58, 237, 0) 100%)",
      ...
      <section
        style={{
          padding: "128px 24px",
          background: `linear-gradient(to bottom, ${THEME.bg}, #000)`,
          position: "relative",
        }}
      >
        <div
      ...
      >
        <div style={{ maxWidth: "800px", margin: "0 auto" }}>
          ...
          >
            Connect your wallet to unlock the full experience. Browse exclusive
            collections, bid in real-time, and manage your portfolio.
          </p>
          <div
            style={{
              letterSpacing: "1px",
